...
int main()
{
    ...
    strm.close();
    std::system("python3 ./Charts/visualize.py ./Charts/randomized_quick_sort/report.csv ./Charts/randomized_quick_sort/report.png");
    openImage("./Charts/randomized_quick_sort/report.png");
    // read_pools();
