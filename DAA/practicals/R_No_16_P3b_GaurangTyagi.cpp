...
int main()
{
    ...
    std::fstream strm("./Charts/merge_sort/report_3b.csv", std::ios::out);
    ...
    strm.close();
    std::system("python3 ./Charts/visualize_2.py ./Charts/merge_sort/report_3b.csv ./Charts/merge_sort/report_3b.png");
    openImage("./Charts/merge_sort/report_3b.png");
